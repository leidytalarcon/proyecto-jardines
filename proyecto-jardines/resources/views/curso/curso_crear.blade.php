                    ...
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group">
                              ...
                              <input type="number" class="form-control col-md-15" name="codigo" id="codigo">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control col-md-15" name="n_estudiantes" id="n_estudiantes">
                            </div>
                            <strong>DOCENTE :</strong>
                            <br>
                         <select name="id_docente" style="width:500px"  >
